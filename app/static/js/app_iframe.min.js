var App = function () {
    var a, b = !1, c = !1, d = !1, e = !1, f = [], g = "../content/superui/", h = "global/img/", i = "base/plugins/",
        j = "global/css/", k = {
            blue: "#89C4F4",
            red: "#F3565D",
            green: "#1bbc9b",
            ...
            "rtl" === $("body").css("direction") && (b = !0), c = !!navigator.userAgent.match(/MSIE 8.0/), d = !!navigator.userAgent.match(/MSIE 9.0/), e = !!navigator.userAgent.match(/MSIE 10.0/), e && $("html").addClass("ie10"), (e || d || c) && $("html").addClass("ie")
        }, m = function () {
            ...
            var a = ($(window).height(), $(".main-footer")), b = $(".main-header"), c = $(".content-tabs"),
                d = App.getViewPort().height - a.outerHeight() - b.outerHeight();
            c.is(":visible") && (d -= c.outerHeight()), $(".tab_iframe").css({height: d, width: "100%"})
        }, o = function () {
            var a = App.getViewPort().height - $(".page-footer").outerHeight() - $(".page-header").outerHeight() - $(".content-tabs").height();
            return a
        }, p = function () {
            jQuery(".page-sidebar-menu").on("click", " li > a.iframeOpen", function (a) {
                a.preventDefault(), App.scrollTop(), $("#iframe-main").attr("src", $(this).attr("href"))
            })
        }, q = function () {
            var a = document.documentElement;
            a.requestFullscreen ? a.requestFullscreen() : a.mozRequestFullScreen ? a.mozRequestFullScreen() : a.webkitRequestFullScreen ? a.webkitRequestFullScreen() : App.alert({
                message: "该浏览器不支持全屏！",
                type: "danger"
            })
        }, r = function () {
            ...
            $("body").on("click", ".portlet > .portlet-title > .tools > a.remove", function (a) {
                ...
                $("body").hasClass("page-portlet-fullscreen") && $("body").removeClass("page-portlet-fullscreen"), b.find(".portlet-title .fullscreen").tooltip("destroy"), b.find(".portlet-title > .tools > .reload").tooltip("destroy"), b.find(".portlet-title > .tools > .remove").tooltip("destroy"), b.find(".portlet-title > .tools > .config").tooltip("destroy"), b.find(".portlet-title > .tools > .collapse, .portlet > .portlet-title > .tools > .expand").tooltip("destroy"), b.remove()
            }), $("body").on("click", ".portlet > .portlet-title .fullscreen", function (a) {
                a.preventDefault();
                var b = $(this).closest(".portlet");
                if (b.hasClass("portlet-fullscreen")) $(this).removeClass("on"), b.removeClass("portlet-fullscreen"), $("body").removeClass("page-portlet-fullscreen"), b.children(".portlet-body").css("height", "auto"); else {
                    ...
                    $(this).addClass("on"), b.addClass("portlet-fullscreen"), $("body").addClass("page-portlet-fullscreen"), b.children(".portlet-body").css("height", c)
                }
            }), $("body").on("click", ".portlet > .portlet-title > .tools > a.reload", function (a) {
                a.preventDefault();
                var b = $(this).closest(".portlet").children(".portlet-body"), c = $(this).attr("data-url"),
                    d = $(this).attr("data-error-display");
                c ? (App.blockUI({target: b, animate: !0, overlayColor: "none"}), $.ajax({
                    type: "GET",
                    cache: !1,
                    url: c,
                    dataType: "html",
                    ...
                    error: function (a, c, e) {
                        ...
                        "toastr" == d && toastr ? toastr.error(f) : "notific8" == d && $.notific8 ? ($.notific8("zindex", 11500), $.notific8(f, {
                            theme: "ruby",
                            life: 3e3
                        })) : alert(f)
                    }
                })) : (App.blockUI({target: b, animate: !0, overlayColor: "none"}), window.setTimeout(function () {
                    App.unblockUI(b)
                }, 1e3))
                ...
                $(this).hasClass("collapse") ? ($(this).removeClass("collapse").addClass("expand"), b.slideUp(200)) : ($(this).removeClass("expand").addClass("collapse"), b.slideDown(200))
            })
        }, t = function () {
            if ($().uniform) {
                var a = $("input[type=checkbox]:not(.toggle, .md-check, .md-radiobtn, .make-switch, .icheck), input[type=radio]:not(.toggle, .md-check, .md-radiobtn, .star, .make-switch, .icheck)");
            ...
            if ($("body").on("click", ".md-checkbox > label, .md-radio > label", function () {
                ...
                $("body").on("click", "a.btn, button.btn, input.btn, label.btn", function (f) {
                    a = $(this), 0 == a.find(".md-click-circle").length && a.prepend("<span class='md-click-circle'></span>"), b = a.find(".md-click-circle"), b.removeClass("md-click-animate"), b.height() || b.width() || (c = Math.max(a.outerWidth(), a.outerHeight()), b.css({
                        height: c,
                        width: c
                    })), d = f.pageX - a.offset().left - b.width() / 2, e = f.pageY - a.offset().top - b.height() / 2, b.css({
                        top: e + "px",
                        left: d + "px"
            ...
            $().iCheck && $(".icheck").each(function () {
                var a = $(this).attr("data-checkbox") ? $(this).attr("data-checkbox") : "icheckbox_minimal-grey",
                    b = $(this).attr("data-radio") ? $(this).attr("data-radio") : "iradio_minimal-grey";
                a.indexOf("_line") > -1 || b.indexOf("_line") > -1 ? $(this).iCheck({
                    checkboxClass: a,
                    radioClass: b,
                    insert: '<div class="icheck_line-icon"></div>' + $(this).attr("data-label")
                }) : $(this).iCheck({checkboxClass: a, radioClass: b})
            })
        }, w = function () {
            ...
            $("[data-auto-height]").each(function () {
                var a = $(this), b = $("[data-height]", a), c = 0, d = a.attr("data-mode"),
                    e = parseInt(a.attr("data-offset") ? a.attr("data-offset") : 0);
                b.each(function () {
    ...
    return {
        init: function () {
            l(), r(), u(), t(), v(), w(), H(), I(), L(), s(), D(), C(), z(), B(), G(), y(), A(), x(), F(), J(), p(), this.addResizeHandler(M), K()
        }, initAjax: function () {
            t(), v(), w(), E(), H(), L(), I(), C(), B(), G(), y(), x()
            ...
            a && ($("body").hasClass("page-header-fixed") ? c -= $(".page-header").height() : $("body").hasClass("page-header-top-fixed") ? c -= $(".page-header-top").height() : $("body").hasClass("page-header-menu-fixed") && (c -= $(".page-header-menu").height()), c += b ? b : -1 * a.height()), $("html,body").animate({scrollTop: c}, "slow")
            ...
            a = $.extend(!0, {}, a);
            var b = "";
            if (b = a.animate ? '<div class="loading-message ' + (a.boxed ? "loading-message-boxed" : "") + '"><div class="block-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>' : a.iconOnly ? '<div class="loading-message ' + (a.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading/loading-spinner-grey.gif" align=""></div>' : a.textOnly ? '<div class="loading-message ' + (a.boxed ? "loading-message-boxed" : "") + '"><span>&nbsp;&nbsp;' + (a.message ? a.message : "LOADING...") + "</span></div>" : '<div class="loading-message ' + (a.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (a.message ? a.message : "LOADING...") + "</span></div>", a.target) {
                var c = $(a.target);
                c.height() <= $(window).height() && (a.cenrerY = !0), c.block({
                    message: b,
                    baseZ: a.zIndex ? a.zIndex : 1e3,
                    centerY: void 0 !== a.cenrerY && a.cenrerY,
            ...
            a && a.animate ? ($(".page-spinner-bar").remove(), $("body").append('<div class="page-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>')) : ($(".page-loading").remove(), $("body").append('<div class="page-loading"><img src="' + this.getGlobalImgPath() + 'loading/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (a && a.message ? a.message : "Loading...") + "</span></div>"))
            ...
            var b = App.getUniqueID("App_alert"),
                c = '<div id="' + b + '" class="custom-alerts alert alert-' + a.type + ' fade in">' + (a.close ? '<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>' : "") + ("" !== a.icon ? '<i class="fa-lg fa fa-' + a.icon + '"></i>  ' : "") + a.message + "</div>";
            return a.reset && $(".custom-alerts").remove(), a.container ? "append" == a.place ? $(a.container).append(c) : $(a.container).prepend(c) : 1 === $(".page-fixed-main-content").size() ? $(".page-fixed-main-content").prepend(c) : ($("body").hasClass("page-container-bg-solid") || $("body").hasClass("page-content-white")) && 0 === $(".page-head").size() ? $(".page-title").after(c) : $(".page-bar").size() > 0 ? $(".page-bar").after(c) : $(".page-breadcrumb, .breadcrumbs").after(c), a.focus && App.scrollTo($("#" + b)), a.closeInSeconds > 0 && setTimeout(function () {
                $("#" + b).remove()
            ...
            var b = {xs: 480, sm: 768, md: 992, lg: 1200};
            return b[a] ? b[a] : 0
        }
    }
}();
            ...
            slimScroll: function (b) {
                ...
                return this.each(function () {
                    ...
                    function e(a, b, c) {
                        ...
                        "scrollTo" in d && d.animate ? v.animate({scrollTop: e}) : v.scrollTop(e), v.trigger("slimscrolling", ~~e), h(), i()
                    }
                    ...
                    if ("ontouchstart" in window && window.navigator.msPointerEnabled && v.css("-ms-touch-action", "none"), v.parent().hasClass(d.wrapperClass)) {
                        var w = v.scrollTop();
                        ...
                        }), "ontouchstart" in window && window.navigator.msPointerEnabled && (v.bind("MSPointerDown", function (a, b) {
...
var addTabs = function (a) {
    var b = {id: 200 * Math.random(), urlType: "relative", title: "新页面"};
    if (a = $.extend(!0, b, a), "relative" == a.urlType) {
        var c = window.location.pathname + "/../";
        a.url = c + a.url
    }
    var d = "tab_" + a.id, e = "", f = "", g = $("#" + d);
    if (!g[0]) {
        var h = App.getViewPort().height - $(".page-footer").outerHeight() - $(".page-header").outerHeight() - $(".content-tabs").height();
        e = '<a href="javascript:void(0);" id="tab_' + d + '"  data-id="' + d + '"  class="menu_tab" >' + a.title, a.close && (e += ' <i class="fa fa-remove page_tab_close" style="cursor: pointer;" data-id="' + d + '" onclick="closeTab(this)"></i>'), e += "</a>";
        var i = "";
        a.content ? f = '<div role="tabpanel" class="tab-pane" id="' + d + '">' + a.content + "</div>" : (App.blockUI({
            target: "#tab-content",
            boxed: !0,
            message: "加载中......"
        }), f = '<div role="tabpanel" class="tab-pane" id="' + d + '">', i = '<iframe onload="javascript:App.unblockUI(\'#tab-content\');" src="' + a.url + '" width="100%" height="' + h + '" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes"  allowtransparency="yes" id="iframe_' + d + '" class="  tab_iframe"></iframe>', f += i, f += "</div>"), $(".page-tabs-content").append(e), g = $(f), $("#tab-content").append(g), g.find("iframe").load(function () {
            App.fixIframeCotent()
        })
    }
    $(".page-tabs-content > a.active").removeClass("active"), $("#tab-content").find(".active").removeClass("active"), $("#tab_" + d).addClass("active"), scrollToTab($(".menu_tab.active")), g.addClass("active")
}, closeTab = function (a) {
    var b = $(a).attr("data-id");
    if ($(".page-tabs-content > a.active").attr("id") === "tab_" + b) {
        var c = $("#tab_" + b).prev(), d = $("#" + b).prev();
        setTimeout(function () {
            c.addClass("active"), d.addClass("active")
        }, 300)
    }
    $("#tab_" + b).remove(), $("#" + b).remove()
}, closeCurrentTab = function () {
    var a = $(".page-tabs-content").find(".active").find(".fa-remove").parents("a");
    a && closeTab(a)
}, refreshTab = function () {
    var a = $(".page-tabs-content").find(".active").attr("data-id"), b = $("#iframe_" + a), c = b.attr("src");
    b.attr("src", c)
    ...
    if (a) {
        ...
        var b = $(".page-tabs-content").children();
        b && ($("#" + b.data("id")).addClass("active"), b.addClass("active"))
    } else $(".page-tabs-content").children("[data-id]").find(".fa-remove").parents("a").not(".active").each(function () {
        $("#" + $(this).data("id")).remove(), $(this).remove()
    })
}, calSumWidth = function (a) {
    var b = 0;
    ...
    var a = Math.abs(parseInt($(".page-tabs-content").css("margin-left"))),
        b = calSumWidth($(".content-tabs").children().not(".menuTabs")), c = $(".content-tabs").outerWidth(!0) - b,
        d = 0;
    if ($(".page-tabs-content").width() < c) return !1;
    for (var e = $(".menu_tab:first"), f = 0; f + $(e).outerWidth(!0) <= a;) f += $(e).outerWidth(!0), e = $(e).next();
    for (f = 0; f + $(e).outerWidth(!0) < c && e.length > 0;) f += $(e).outerWidth(!0), e = $(e).next();
    d = calSumWidth($(e).prevAll()), d > 0 && $(".page-tabs-content").animate({marginLeft: 0 - d + "px"}, "fast")
}, scrollToTab = function (a) {
    var b = calSumWidth($(a).prevAll()), c = calSumWidth($(a).nextAll()),
        d = calSumWidth($(".content-tabs").children().not(".menuTabs")), e = $(".content-tabs").outerWidth(!0) - d,
        f = 0;
    if ($(".page-tabs-content").outerWidth() < e) f = 0; else if (c <= e - $(a).outerWidth(!0) - $(a).next().outerWidth(!0)) {
        if (e - $(a).next().outerWidth(!0) > c) {
            f = b;
            for (var g = a; f - $(g).outerWidth() > $(".page-tabs-content").outerWidth() - e;) f -= $(g).prev().outerWidth(), g = $(g).prev()
        }
    } else b > e - $(a).outerWidth(!0) - $(a).prev().outerWidth(!0) && (f = b - $(a).prev().outerWidth(!0));
    $(".page-tabs-content").animate({marginLeft: 0 - f + "px"}, "fast")
    ...
    if ($(".page-tabs-content").width() < c) return !1;
    for (var e = $(".menu_tab:first"), f = 0; f + $(e).outerWidth(!0) <= a;) f += $(e).outerWidth(!0), e = $(e).next();
    if (f = 0, calSumWidth($(e).prevAll()) > c) {
        for (; f + $(e).outerWidth(!0) < c && e.length > 0;) f += $(e).outerWidth(!0), e = $(e).prev();
        d = calSumWidth($(e).prevAll())
    }
    $(".page-tabs-content").animate({marginLeft: 0 - d + "px"}, "fast")
}, activeTab = function () {
    var a = $(this).attr("data-id");
    $(".menu_tab").removeClass("active"), $("#tab-content > .active").removeClass("active"), $("#tab_" + a).addClass("active"), $("#" + a).addClass("active"), scrollToTab($(".menu_tab.active"))
};
$(function () {
 ...
 */
    !function () {
        ...
        function a(a) {
                ...
                if (d = a.extend({}, a.blockUI.defaults, d || {}), !d.ignoreIfBlocked || !a(b).data("blockUI.isBlocked")) {
                    ...
                    if (l || B) {
                        if (q && d.allowBodyStretch && a.support.boxModel && a("html,body").css("height", "100%"), (l || !a.support.boxModel) && !q) var C = i(b, "borderTopWidth"),
                            D = i(b, "borderLeftWidth"), E = C ? "(0 - " + C + ")" : 0, F = D ? "(0 - " + D + ")" : 0;
            ...
            function h(a, b, c) {
                var d = a.parentNode, e = a.style, f = (d.offsetWidth - a.offsetWidth) / 2 - i(d, "borderLeftWidth"),
    ...
    a.fn.sidebarMenu = function (b) {
        function c(b, d, e) {
            a.each(d, function (d, f) {
                var g = a('<li class="header"></li>');
                if (null != f.isHeader && f.isHeader === !0) return g.append(f.text), void b.append(g);
                var h, i = a('<li class="treeview " data-level="' + e + '"></li>');
                h = a(e > 0 ? '<a style="padding-left:' + 20 * e + 'px"></a>' : "<a></a>");
                var j = a("<i></i>");
                j.addClass(f.icon);
                var k = a('<span class="title"></span>');
                k.addClass("menu-text").text(f.text), h.append(j), h.append(k), h.addClass("nav-link");
                var l = f.isOpen;
                if (l === !0 && i.addClass("active"), f.children && f.children.length > 0) {
                    var m = a('<span class="pull-right-container"></span>'),
                        n = a('<i class="fa fa-angle-left pull-right"></i>');
                    m.append(n), h.append(m), i.append(h);
                    var o = a("<ul></ul>");
                    o.addClass("treeview-menu"), l === !0 ? (o.css("display", "block"), o.addClass("menu-open")) : o.css("display", "none"), c(o, f.children, e + 1), i.append(o)
                } else {
                    if (null != f.targetType && "blank" === f.targetType) h.attr("href", f.url), h.attr("target", "_blank"); else if (null != f.targetType && "ajax" === f.targetType) h.attr("href", f.url), h.addClass("ajaxify"); else if (null != f.targetType && "iframe-tab" === f.targetType) {
                        var p = "addTabs({id:'" + f.id + "',title: '" + f.text + "',close: true,url: '" + f.url + "'});";
                        h.attr("onclick", p)
                    } else null != f.targetType && "iframe" === f.targetType ? (h.attr("href", f.url), h.addClass("iframeOpen"), a("#iframe-main").addClass("tab_iframe")) : (h.attr("href", f.url), h.addClass("iframeOpen"), a("#iframe-main").addClass("tab_iframe"));
                    h.addClass("nav-link");
                    var q = a("<span></span>");
                    null != f.tip && f.tip > 0 && q.addClass("label").addClass("label-success").text(f.tip), h.append(q), i.append(h)
                }
                b.append(i)
            })
        }

        b = a.extend({}, a.fn.sidebarMenu.defaults, b || {});
        var d = a(this), e = 0;
        if (b.data) c(d, b.data, e); else {
            if (!b.url) return;
            a.getJSON(b.url, b.param, function (a) {
                c(d, a, e)
            })
        }
        d.on("click", "li.treeview a", function () {
            a(this);
            a(a.AdminLTE.options.sidebarToggleSelector).click()
        })
    }, a.fn.sidebarMenu.defaults = {url: null, param: null, data: null, isHeader: !1}
}(jQuery);